    ...
    <>
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogContent className="bg-white dark:bg-[#0a0a0a] border-gray-200 dark:border-[#1a1a1a] text-gray-900 dark:text-white max-w-md">
          ...
          <div className="flex justify-end gap-2 pt-4 border-t border-gray-200 dark:border-[#1a1a1a]">
            <Button
              variant="ghost"
      ...
      <div className="flex gap-4 items-center">
        ...
        {title && (
          <div className="flex gap-2 items-center">
            {TitleIcon ? (
              <TitleIcon className="w-5 h-5 text-gray-900 dark:text-white" />
            ) : (
      ...
      <div className="flex gap-2 items-center">
        {showActionButtons && (
          <>
            {onCreate && (
              <button
                onClick={onCreate}
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-[#1a1a1a] px-3 py-1.5 rounded text-sm transition-colors flex items-center gap-2"
              >
        ...
        <button
          ...
          className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-[#1a1a1a] px-3 py-1.5 rounded text-sm transition-colors"
        >
          로그아웃
        </button>
      </div>
